...
public class NQueen {
    ...
    public static void main(String[] args) {
        System.out.println("The n-queens puzzle is the problem of placing n queens on an n x n chessboard such that no two queens attack each other.");
    ...
    private static void backtrack(int row, Set<Integer> diagonals, Set<Integer> antiDiagonals, Set<Integer> cols, char[][] state) {
